...
* The original package name 'com.pranav.springboot.learn-jpa-and-hibernate' is invalid and this project uses 'com.pranav.springboot.learnjpaandhibernate' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.2.0-M2/reference/htmlsingle/index.html#data.sql.jdbc)
